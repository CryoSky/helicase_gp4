...
simulation.reporters.append(PDBReporter(os.path.join(toPath, "minimized.pdb"), 1))
# simulation.reporters.append(DCDReporter(os.path.join(toPath, "output.dcd"), 1))
