...
def set_up_forces(oa, computeQ=False, submode=-1, contactParameterLocation=".", membrane_center=-0*angstrom):
    ...
    forces = []
    if computeQ:
        forces.append(q_interface_value(oa, "6n7t_merged_new_new_cg_swap.pdb", reference_chain_name="ABCDEF", forceGroup=1))
...
pdb_trajectory = md.load('../20201003_protein_dna_morph/model_050.pdb', stride=1)
