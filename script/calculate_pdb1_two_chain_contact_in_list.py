...
def compute_contactmap(ca_atoms_pdb, dna_atoms_pdb, output_filename):
...
def main():
    ...
    parser.add_argument("PDB_filename1", help="The file name of input pdb file", type=str)
    parser.add_argument("chain1", help="The chain 1 ID", type=str)
    parser.add_argument("chain2", help="The chain 2 ID", type=str)
    parser.add_argument("output_filename", help="The file name of csv", type=str)
    ...
    full_contactmap = np.zeros((51, 483))
    ...
    for i in range(int(n_snapshot)):
        ...
        dna_atoms_pdb1 = pdb_load_dna(pdb1_file, 'G', '1', '51')
        begin1, contactmap1 = compute_contactmap(ca_atoms_pdb1, dna_atoms_pdb1, output_filename)
